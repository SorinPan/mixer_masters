"""
Django settings for mixer_masters project.
...
ROOT_URLCONF = 'mixer_masters.urls'
...
WSGI_APPLICATION = 'mixer_masters.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'mixer-masters-e6fd6c2a39a2'
...
STANDARD_SHIPPING = Decimal('4.99')
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'mixermasters@example.com'
else:
